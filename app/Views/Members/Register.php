			...
			<?php echo Form::open(array('method' => 'post')); ?>
				...
				<?php if(isset($invite_code)){ ?>
					...
					<div class='input-group' style='width: 100%; margin-bottom: 25px'>
						...
						<?php echo Form::input(array('id' => 'invite', 'type' => 'text', 'name' => 'invite', 'class' => 'form-control', 'placeholder' => 'Invitation Code')); ?>
						<span id='resultinvite' class='input-group-addon'></span>
					</div>
				<?php } ?>
