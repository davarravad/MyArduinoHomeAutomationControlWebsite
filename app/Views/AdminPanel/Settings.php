...
<div class='col-lg-12 col-md-12 col-sm-12'>
  <div class='row'>
    ...
    <div class='col-lg-12 col-md-12 col-sm-12'>
    	<div class='panel panel-default'>
    		<div class='panel-heading'>
    			<h3 class='jumbotron-heading'>Site Invite Code Settings</h3>
    		</div>
    		<div class='panel-body'>
                Site Invite Code. Invitation Code for New Users.  Leave blank to disable.

                <!-- Invite Code -->
    			<div class='input-group' style='margin-bottom: 25px'>
    				<span class='input-group-addon'><i class='glyphicon glyphicon-globe'></i> Invite Code</span>
    				<?php echo Form::input(array('type' => 'text', 'name' => 'site_user_invite_code', 'class' => 'form-control', 'value' => $site_user_invite_code, 'placeholder' => 'Invite Code', 'maxlength' => '100')); ?>
    			</div>
